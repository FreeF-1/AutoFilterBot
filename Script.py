class script(object):
    START_TXT = """𝗛𝗲𝗹𝗹𝗼. {},
𝗠ʏ 𝗦ᴇʟғ <a href=https://t.me/{}>{}</a>, 

『 ✦ 𝙄 𝙘𝙖𝙣 𝙋𝙧𝙤𝙫𝙞𝙙𝙚 𝙖 𝙡𝙤𝙩 𝙤𝙛 𝙢𝙤𝙫𝙞𝙚𝙨, 𝙅𝙪𝙨𝙩 𝘼𝙙𝙙 𝙢𝙚 𝙜𝙧𝙤𝙪𝙥 & 𝙎𝙚𝙚 𝙢𝙮 𝙢𝙖𝙜𝙞𝙘 ✨🔥 』"""
    HELP_TXT = """𝙃𝙚𝙮, {}
    
𝗛𝗲𝗿𝗲 𝗶𝘀 𝘁𝗵𝗲 𝗵𝗲𝗹𝗽 𝗙𝗼𝗿 𝗠𝘆 𝗖𝗼𝗺𝗺𝗮𝗻𝗱𝘀 """
    ABOUT_TXT = """<b>✯ 𝗠ʏ 𝗡ᴀᴍᴇ: {}
✯ 𝗖ʀᴇᴀᴛᴏʀ: <a href=https://t.me/ChillxNow>Creator</a>
✯ 𝙳𝙰𝚃𝙰 𝙱𝙰𝚂𝙴: 𝙼𝙾𝙽𝙶𝙾 𝙳𝙱
✯ 𝙱𝙾𝚃 𝚂𝙴𝚁𝚅𝙴𝚁: 𝙷𝙴𝚁𝙾𝙺𝚄
